...
<template>
  <div class="admin-list">
    <div class="admin-header">
      ...
      <button type="button" class="btn btn-primary" @click="router.push('/admin/vehicles/new')">Add vehicle</button>
    </div>
    <div class="filters">
      ...
      <table class="admin-table">
        ...
        <tbody>
          <tr v-for="v in vehicles" :key="v.id">
            ...
            <td>{{ v.views_count }}</td>
            <td>
              <button type="button" class="btn btn-sm" @click="router.push(`/admin/vehicles/${v.id}`)">Edit</button>
